  ...
  const handleDownloadReport = () => {
    if (patientData) {
      ...
      const addHeader = () => {
        ...
        doc.text(`Address: ${patient.address}`, 70, yPos, true, false);
        doc.text(
      ...
      const combinedData = order_details.map((detail, index) => ({
        ...detail,
        result: results[index], // Assuming order_details and results have the same length
      }));
      ...
      combinedData.forEach((data, index) => {
        ...
        Object.keys(correspondingResult.data).forEach((key) => {
          const { value, unit, reference_range } =
            correspondingResult.data[key];
          addSingleColumnRow(
            `${key}:`,
            `${value} ${unit}`,
            `(${reference_range})`
...
//     // Adding Patient, Physician, Sample columns
//     doc.setFontSize(12);
...
//     // Adding Patient Details
//     doc.setFontSize(10);
//     doc.text(`Patient Name: ${patient.patient_name}`, 10, yPos,true,false);
//     doc.text(`Address: ${patient.address}`, 70, yPos,true,false);
//     doc.text(`Ethnic Group: ${patient.ethnic_group}`, 140, yPos,true,false);
//     yPos += 6;
...
//     doc.text(`Death Indicator: ${patient.death_indicator}`, 140, yPos,true,false);
//     yPos += 6;
...
//  {/* Reports for this specimen */}
//  <div className="mt-4">
//                           {reports
//                             .filter(
//                               (report) => report.specimen_id === specimen.id
//                             )
...
//               <table className="min-w-full divide-y divide-gray-200">
//                 <thead className="bg-gray-50 ">
//                   <tr className="mb-8 grid grid-cols-1">
//                     <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
//                       Order Details
//                     </th>
//                   </tr>
...
//                 </thead>
//                 <tbody className="bg-white divide-y divide-gray-200">
//                 <tr className="my-8 grid grid-cols-3">
...
//             </div>
//           <div className="mb-6">
//             <h2 className="text-3xl font-bold mb-6">Visits</h2>
...
//                   </p>
//                   <p>
//                     <strong>Hospital Service:</strong>{" "}
//                     {visit.hospital_service}
//                   </p>
//                   <p>
//                     <strong>Patient Type:</strong> {visit.patient_type}
//                   </p>
...
//           {/* Diagnosis */}
//           <div className="mb-6">
//             <h2 className="text-3xl font-bold mb-6">Diagnosis</h2>
//             <div className="grid grid-cols-1 gap-6">
//               {diagnosis.map((diag, index) => (
//                 <div key={index} className="bg-white shadow-md rounded-lg p-4">
//                   <p>
